    ...
    <div className="container">
      ...
      <div className="form-group">
        ...
        <div className="input-group">
          ...
          <input type="text" value={location && location.address} className="form-control" readOnly />
        </div>
      </div>
      <div className="form-group">
        ...
        <div className="input-group">
          ...
          <input type="text" value={location && location.district} className="form-control" readOnly />
        </div>
      </div>
      <div className="form-group">
        ...
        <div className="input-group">
          ...
          <input type="text" value={location && location.city} className="form-control" readOnly />
        </div>
      </div>
